...
def test_select_specific_fields(db_mock_detailed: SqliterDB) -> None:
...
def test_select_multiple_fields(db_mock_detailed: SqliterDB) -> None:
...
def test_select_all_fields(db_mock_detailed: SqliterDB) -> None:
...
def test_select_with_filter(db_mock_detailed: SqliterDB) -> None:
...
def test_select_nonexistent_field(db_mock_detailed: SqliterDB) -> None:
...
def test_select_partial_fields_model_integrity(
    ...
    """Test that partial field selection doesn't affect the original model."""
    db_mock_detailed.select(
        DetailedPersonModel, fields=["name", "age"]
    ).fetch_all()
