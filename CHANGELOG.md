...
- Add caching controls to SqliterDB.get ([#114](https://github.com/seapagan/sqliter-py/pull/114)) by [seapagan](https://github.com/seapagan)

**Documentation**

- Docs: add comprehensive API reference section ([#113](https://github.com/seapagan/sqliter-py/pull/113)) by [seapagan](https://github.com/seapagan)

[`Full Changelog`](https://github.com/seapagan/sqliter-py/compare/0.15.0...0.16.0) | [`Diff`](https://github.com/seapagan/sqliter-py/compare/0.15.0...0.16.0.diff) | [`Patch`](https://github.com/seapagan/sqliter-py/compare/0.15.0...0.16.0.patch)
